...
for name = ["Q", "V"]
    ...
    weight_slack = ctrl.add_par('weight_slack', ...
                                            flip(size(ctrl.vars.slack)));
    ...
    % initial and final learnable costs
    cost = Vcost( ...                                       
            ctrl.vars.w(:, 1), ...
            ctrl.vars.rho(:, 1), ...
            ctrl.vars.v(:, 1), ...
        ...
        + Tcost( ...                           
            ...
            normalization.rho, ...
            normalization.v) ...
        + weight_slack(end, :) * ctrl.vars.slack(:, end);
    % stage cost
    for k = 2:M * Np
        cost = cost ...
            + weight_slack(k, :) * ctrl.vars.slack(:, k) ...          
            + Lcost( ...                                    
                ctrl.vars.rho(:, k), ...
                ctrl.vars.v(:, k), ...
                ctrl.pars.rho_crit, ...
